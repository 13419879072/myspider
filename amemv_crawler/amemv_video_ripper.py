...
class CrawlerScheduler(object):
    ...
    def generateSignature(value):
        p = os.popen('node fuck_byted_acrawler.js %s' % value)
...
def usage():
    print("1. Please create file share_url.txt under this same directory.\n"
          "2. In share_url.txt, you can specify amemv share page url separated by "
          "comma/space/tab/CR. Accept multiple lines of text\n"
          "3. Save the file and retry.\n\n"
          "Sample File Content:\nurl1,url2\n\n"
          "Or use command line options:\n\n"
          "Sample:\npython amemv_video_ripper.py number1,number2\n\n\n")
    print(u"未找到share_url.txt文件，请创建.\n"
          u"请在文件中指定抖音分享页面URL，并以 逗号/空格/tab/表格鍵/回车符 分割，支持多行.\n"
          u"保存文件并重试.\n\n"
          u"例子: url1,url12\n\n"
          u"或者直接使用命令行参数指定站点\n"
          u"例子: python amemv_video_ripper.py url1,url2")

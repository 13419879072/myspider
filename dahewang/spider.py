...
class DaHeSpider:
    def __init__(self):
        self.star_url = "http://bbs.dahe.cn/search.php?mod=forum&searchid=8417&orderby=sphinx&ascdesc=desc&searchsubmit=yes&kw=%CE%A5%B7%A8"
        self.headers = {
    ...
    def run(self):
        ...
        while True:
            ...
            for li in lis:
                ...
                for div in divs:
                    dic = {}
                    dic['detail_uname'] = "".join(div.xpath('.//a[@class="xw1"]//text()'))  #名字
                    ...
                    dic['detail_from'] = "".join(div.xpath('.//span[@class="xg1"]//text()'))    #来自
